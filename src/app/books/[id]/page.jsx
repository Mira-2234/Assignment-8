          ...
          <div className="p-8 flex-1">
            ...
            <div className="flex gap-4">
              <button
                ...
                className="bg-blue-700 text-white px-6 py-3 rounded-xl font-semibold text-lg hover:bg-blue-800 transition disabled:opacity-50 disabled:cursor-not-allowed"
              >
              ...
              <button
                onClick={() => router.back()}
                className="border border-gray-200 text-gray-600 px-6 py-3 rounded-xl font-medium hover:bg-gray-100 transition"
              >
                ← Go Back
              </button>
            </div>
